            ...
            <div className="relative min-h-screen w-full flex flex-col justify-center items-center py-24 px-4 md:px-8">
                <div className="container mx-auto max-w-7xl">
                    ...
                    <motion.div
                        ...
                        className="grid grid-cols-1 place-items-center relative z-10"
                    >
                        {/* The Zonda R Card */}
                        <Card
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-5 h-full min-h-[500px]">
                                ...
                                <div className="lg:col-span-3 relative overflow-hidden bg-gradient-to-br from-black/5 to-black/20 dark:from-white/[0.02] dark:to-transparent min-h-[300px] lg:min-h-full">
                                    <div className="absolute inset-0 flex items-center justify-center transition-transform duration-700 group-hover:scale-105">
                                        ...
                                        <SketchfabEmbed hideUi={true} className="pointer-events-none opacity-90 grayscale-[0.2] group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-700" />
                                    </div>
                                ...
                                <CardContent className="lg:col-span-2 p-8 md:p-12 flex flex-col justify-center relative bg-gradient-to-br from-card/50 to-card/10">
                                    ...
                                    <div className="mb-auto">
                                        <p className="text-primary font-bold mb-2 tracking-[0.2em] uppercase text-xs">{carData.year} Edition</p>
                                        <h3 className="text-4xl md:text-5xl font-bold text-card-foreground mb-4 tracking-tighter leading-[0.9]">{carData.name}</h3>
                                        <p className="text-muted-foreground text-lg font-light leading-relaxed">{carData.tagline}</p>
                                    </div>
                                    ...
                                    <div className="mt-8 space-y-6">
                                        <div className="grid grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <p className="font-semibold text-foreground">{carData.engine}</p>
                                            </div>
                                            <div>
                                                <p className="text-[10px] uppercase tracking-wider text-muted-foreground mb-1">Output</p>
                                                <p className="font-semibold text-foreground">{carData.horsepower}</p>
                                            </div>
                                        </div>
